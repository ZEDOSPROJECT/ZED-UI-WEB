    ...
    render(){
        ...
        const appList = this.state.Apps.map((app) =>{ 
            ...
            if(app.Name !== "Settings" && show) {
                ...
                return <div key={"stmenu_"+app.Name}>{newDiv}<AppCard forceRefreshApps={this.refreshApps} windowSize={app.manifest.Window} onClickApp={this.props.onClickApp} appName={app.Name}  /></div>
            }else{
                return null;
            } 
        });
