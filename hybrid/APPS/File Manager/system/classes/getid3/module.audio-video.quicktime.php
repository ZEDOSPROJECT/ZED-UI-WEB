...
class getid3_quicktime extends getid3_handler
{
	...
	public function Analyze() {
		...
		$offset      = 0;
		$atomcounter = 0;
		$atom_data_read_buffer_size = ($info['php_memory_limit'] ? round($info['php_memory_limit'] / 2.5) : $this->getid3->option_fread_buffer_size * 1024); // allow [default: 32MB] if PHP configured with no memory_limit
