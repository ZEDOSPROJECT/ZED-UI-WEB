const {app, BrowserWindow} = require('electron')
  ...
  function createWindow () {
    ...
    setTimeout(() => {
      win.loadURL("file://"+__dirname+'/index.html',{userAgent: 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/76.0.3626.120 Safari/537.36'});
    }, 200);
